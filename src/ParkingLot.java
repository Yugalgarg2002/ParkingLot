...
public class ParkingLot {
    ...
    private void parkBikeVehicle(Vehicle vehicle) {
        ...
        bikeSpotSize--;
        System.out.println("Vehicle BIKE parked sucessfully");
    }
    ...
    private void parkCompactVehicle(Vehicle vehicle) {
        ...
        compactSpotSize--;
        System.out.println("Vehicle CAR parked sucessfully");
    ...
    private void parkLargeVehicle(Vehicle vehicle) {
        ...
        largeSpotSize--;
        System.out.println("Vehicle TRUCK parked sucessfully");
    ...
    public void unparkTheVehicle(Vehicle vehicle) {
        ...
        System.out.println("Unparking the vehicle sucessfully");
    }
